...
public class ZooKeeperClient implements AutoCloseable {
    ...
    public Optional<ZkEpoch> fenceBecomeCoordinatorLeader(int coordinatorId) throws Exception {
        ...
        try {
            ...
            // atomically update epoch and get the resulting Stat for the real new zk version
            Stat resultStat =
                    zkClient.setData()
            ...
            return Optional.of(new ZkEpoch(newCoordinatorEpoch, resultStat.getVersion()));
    ...
    public void ensureEpochZnodeExists() throws Exception {
        ...
        if (zkClient.checkExists().forPath(path) == null) {
            try {
                ...
                // Another coordinator server may have created the node concurrently.
                // This is safe to ignore.
                LOG.info("Epoch znode already exists, created by another coordinator.");
            }
        }
    }
