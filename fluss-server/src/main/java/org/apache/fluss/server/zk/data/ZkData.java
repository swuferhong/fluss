...
public final class ZkData {
    ...
    public static final class CoordinatorEpochZNode {
        ...
        public static byte[] encode(int epoch) {
            return String.valueOf(epoch).getBytes(java.nio.charset.StandardCharsets.UTF_8);
        }

        public static int decode(byte[] bytes) {
            return Integer.parseInt(new String(bytes, java.nio.charset.StandardCharsets.UTF_8));
        }
    }
    // ------------------------------------------------------------------------------------------
